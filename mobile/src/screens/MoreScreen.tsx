...
const ROWS: { icon: IconName; labelKey: 'gallery' | 'faq' | 'services' | 'ebooks' | 'contactUs' | 'nusuk' | 'packing' | 'vaccine' | 'duas' | 'azkaar' | 'quran' | 'hadith' | 'customize' | 'settings'; target: keyof RootStackParamList }[] = [
  ...
  { icon: 'book', labelKey: 'hadith', target: 'Hadith' },
